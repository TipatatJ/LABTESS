...
$access_token = 'zh0aCwZWQ2r7qZ/We+7ENVHLGR1QKxSczm4I31ncxHVXHJyNl8qjKwoDVhblGKueSjKcN2yxc1gcVBnxJV+66cM3nXJb7HZHlf/rejVKoBbqDrhPovMc+9AubD8qds89iMxi3v7PC4seDN3MD8OVxAdB04t89/1O/w1cDnyilFU=';
$arrBreakKW = array(
            'ขอบคุณที่สนใจเป็นส่วนหนึ่งของ แผนไทย ด่านหน้าสู้ COVID (TTM MAP) เริ่มต้นกรอกข้อมูลโดยการเลือกที่ Rich menu ด้านล่าง',
            'PMgeneralAdvise',
            'PMriskAdvise',
            //'occupation,1','occupation,2','occupation,3',
            //'acup,1','acup,2',
            'wechagum','no wechagum',
            'pecahagum','no pecahagum',
            'labout','no labour',
            //'CHherb,1','CHherb,2',
            //'serve herb','no herb',
            //'tuina,1','tuina,2',
            ...
            'MD Prescriber','TTM doctor','TTM user',
...
if (!is_null($events['events'])) {
    ...
    foreach ($events['events'] as $event) {
        ...
        if ($event['type'] == 'message' && $event['message']['type'] == 'text') {
            ...
            include_once('lastMsgTTMHandler.php');
        ...
        //          file_put_contents('body.txt',file_get_contents('php://input'));
            ...
            $jsonMsg = '{
                ...
                "altText": "this is a buttons template",
                    "template": {
                        ...
                        {
                            "type": "postback",
                            "label": "แชร์ตำแหน่งบน TTM Map",
                            "text": "Share on TTM Map",
                            "data": "MyLocation,1"
                        },
                        {
                            "type": "postback",
            ...
            include_once('postBackTTMHandler.php');
            ...
            //if("Ub3f6b90b35b51d817a89835f9afaf8c7"){
                ...
                $messages = [
                    ...
                    หรือเริ่มกรอกข้อมูลใหม่ที่ปุ่ม ริชเมนู ด้านล่าง
                    ',
                ];
...
function txImg2WTH($fields){
        //######################################################################################################

        // Make a POST to save SMS to Wiztech LINE sms
        $url = 'https://www.venitaclinic.com/Qweb/site1_wiztech/WiztechSolution/include/smsImg.php';
        //$fields = array("userId"=>$userId,"txt"=>$text, "me"=>$me);
...
function getUserLastMessage($userId){
    ...
    $rtnWTH = file_get_contents($url.'?userId='.$userId.'&mapType=TTM');
